...
public abstract class AppUtils {
    ...
    public static int getPreferredDialogWidth(Context context) {
        return getPreferredDialogWidth(context, 0.85f, 0.65f);
    }

    public static int getPreferredDialogWidth(Context context, float scalePortrait, float scaleLandscape) {
        int orientation = context.getResources().getConfiguration().orientation;
        float scale = orientation == Configuration.ORIENTATION_PORTRAIT ? scalePortrait : scaleLandscape;
