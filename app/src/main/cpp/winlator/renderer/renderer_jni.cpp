...
Java_com_winlator_cmod_widget_DisplayXView_nativeInit(JNIEnv *env, jobject thiz, jobject context, jobject xServer) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeCreateWindow(JNIEnv *env, jobject thiz, jobject windowObj, jint parentId) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeMapWindow(JNIEnv *env, jobject thiz, jint id) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeUnmapWindow(JNIEnv *env, jobject thiz, jint id) {
    auto window = windowManager.getWindow(id);
    if (!window) return;
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeDestroyWindow(JNIEnv *env, jobject thiz, jint id) {
    auto window = windowManager.getWindow(id);
    if (!window) return;
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeCreateCursor(JNIEnv *env, jobject thiz, jobject cursorObj) {
    auto drawable = std::make_unique<struct Drawable>();
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeFreeCursor(JNIEnv *env, jobject thiz, jint id) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeBindCursor(JNIEnv *env, jobject thiz, jint windowId, jint cursorId, jboolean visible) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativePointerMove(JNIEnv *env, jobject thiz, jint posX, jint posY) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeChangeWindowZOrder(JNIEnv *env, jobject thiz, jint stackMode, jint id, jint siblingId) {
    auto window = windowManager.getWindow(id);
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeUpdateWindowGeometry(JNIEnv *env, jobject thiz, jint id, jint width, jint height, jint x, jint y, jboolean resized) {
    auto window = windowManager.getWindow(id);
    if (!window) return;
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeUpdateWindowContent(JNIEnv *env, jobject thiz, jint id) {
    auto window = windowManager.getWindow(id);
    if (!window) return;
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeReparentWindow(JNIEnv *env, jobject thiz, jint id, jint parentId) {
    auto window = windowManager.getWindow(id);
    auto parent = windowManager.getWindow(parentId);
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeToggleFullscreen(JNIEnv *env, jobject thiz) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeSetCursorVisible(JNIEnv *env, jobject thiz, jboolean visible) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeSetScreenOffsetYRelativeToCursor(JNIEnv *env, jobject thiz, jboolean cond) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeSetMagnifierZoom(JNIEnv *env, jobject thiz, float magnifierZoom) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeSetUnviewableWMClass(JNIEnv *env, jobject thiz, jstring unviewableWMName) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeSetWindowClassName(JNIEnv *env, jobject thiz, jint id, jstring className) {
    auto window = windowManager.getWindow(id);
    if (!window) return;
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeCreateSurface(JNIEnv *env, jobject thiz, jobject surface) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeDestroySurface(JNIEnv *env, jobject thiz) {
    if (xserver.isDisplayX())
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeChangeSurface(JNIEnv *env, jobject thiz, jint width, jint height) {
    if (xserver.isDisplayX())
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativePause(JNIEnv *env, jobject thiz) {
    if (!xserver.isDisplayX())
        renderer.pause();
    else
        displayX.pause();     
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeResume(JNIEnv *env, jobject thiz) {
    if (!xserver.isDisplayX())
        renderer.resume();
    else
        displayX.resume();       
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeStop(JNIEnv *env, jobject thiz) {
    if (!xserver.isDisplayX())
        renderer.stop();
    else    
        displayX.stop();
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeAddDirectContent(JNIEnv *env, jobject thiz, jint windowId, jobject drawableObj) {
    auto window = windowManager.getWindow(windowId);
    if (!window) return;
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeUpdateDirectContent(JNIEnv *env, jclass obj, jint windowId, jint drawableId) {
    auto window = windowManager.getWindow(windowId);
    if (!window) return;
...
extern "C" JNIEXPORT void JNICALL
Java_com_winlator_cmod_widget_DisplayXView_nativeRemoveDirectContent(JNIEnv *env, jclass obj, jint windowId, jint drawableId) {
    auto window = windowManager.getWindow(windowId);
    if (!window) return;
